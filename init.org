...
(e:deferred-config! ellama
  ...
  (setopt ellama-providers
          '(;; Claude
            ("claude-opus-4"   . (make-llm-claude :key claude-api-key :chat-model "claude-opus-4-20250514"))
            ("claude-sonnet-4" . (make-llm-claude :key claude-api-key :chat-model "claude-sonnet-4-20250514"))
            ;; Open AI
            ("gpt-4.1-nano" . (make-llm-openai :key openai-api-key :chat-model "gpt-4.1-nano"))
  ...
  (setopt ellama-provider             (eval (cdr (assoc "claude-sonnet-4" ellama-providers))))
  (setopt ellama-coding-provider      (eval (cdr (assoc "claude-sonnet-4" ellama-providers))))
  (setopt ellama-translation-provider (eval (cdr (assoc "claude-sonnet-4" ellama-providers)))))
#+end_src
