...
(e:deferred-config! ellama
  ...
  (setopt ellama-provider (eval (cdr (assoc "codegemma" ellama-providers))))
...
(e:deferred-config! magit
  ...
  (when (require 'forge nil t)
    ...
    (set-face-attribute 'forge-pullreq-merged nil :foreground nil :inherit 'forge-dimmed)
    (set-face-attribute 'forge-pullreq-rejected nil :foreground nil :inherit 'forge-dimmed))
