...
(e:deferred-config! org-modern-indent
  ...
  :defer-config
  (setopt org-modern-indent-begin (propertize "╭ " 'face 'org-modern-indent-bracket-line))
  (setopt org-modern-indent-guide (propertize "│ " 'face 'org-modern-indent-bracket-line))
  (setopt org-modern-indent-end   (propertize "╰ " 'face 'org-modern-indent-bracket-line)))
#+end_src
** org-refile
#+begin_src emacs-lisp
