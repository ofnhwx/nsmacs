...
(e:deferred-config! ellama
  ...
  (setopt ellama-provider             (eval (cdr (assoc "gpt-4.1-nano" ellama-providers))))
  (setopt ellama-coding-provider      (eval (cdr (assoc "gpt-4.1-nano" ellama-providers))))
  (setopt ellama-translation-provider (eval (cdr (assoc "gpt-4.1-nano" ellama-providers)))))
#+end_src
