...
(e:key-def root nil
  ...
  "@ ESC" 'claude-send-tmux-send-escape
  "@1" 'claude-send-tmux-send-1
  "@2" 'claude-send-tmux-send-2
  "@3" 'claude-send-tmux-send-3
  "@@" 'claude-send-tmux-message
  "@q" 'claude-send-tmux-send-q
  "^" 'ace-window
