...
*** dired-filter
#+begin_src emacs-lisp
(e:deffered-config! dired-filter
  :hook (dired-mode-hook . dired-filter-mode))
#+end_src
*** dired-toggle-sudo
#+begin_src emacs-lisp
(e:deffered-config! dired-toggle-sudo)
#+end_src
*** nerd-icons-dired
#+begin_src emacs-lisp
(e:deffered-config! nerd-icons-dired
  :hook (dired-mode-hook . nerd-icons-dired-mode))
#+end_src
*** ls-lisp-extension
#+begin_src emacs-lisp
(e:deffered-config! ls-lisp-extension
  :after (dired)
  :config
...
** google-translate
#+begin_src emacs-lisp
(e:deffered-config! google-translate
  :config
...
** evil-collection
#+begin_src emacs-lisp
(e:deffered-config! evil-collection
  :after (evil)
  :config
...
** evil-easymotion
#+begin_src emacs-lisp
(e:deffered-config! evil-easymotion
  :after (evil)
  :defvar (evilem-map)
  :config
...
** evil-goggles
#+begin_src emacs-lisp
(e:deffered-config! evil-goggles
  :after (evil)
  :config
  (evil-goggles-mode 1))
#+end_src
...
** evil-nerd-commenter
#+begin_src emacs-lisp
(e:deffered-config! evil-nerd-commenter
  :after (evil)
  :require t)
#+end_src
** evil-surround
#+begin_src emacs-lisp
(e:deffered-config! evil-surround
  :after (evil)
  :config
...
#+begin_src emacs-lisp
(e:deffered-config! evil-textobj-tree-sitter
...
** ddskk-posframe
#+begin_src emacs-lisp
(e:deffered-config! ddskk-posframe
  :after (skk)
  :config
...
*** company-org-block
#+begin_src emacs-lisp
(e:deffered-config! company-org-block
...
(e:deffered-config! corfu
  ...
  :init
  (eval-and-compile
    (add-to-list 'load-path (f-expand "corfu/extensions" borg-drones-directory))
    (require 'corfu-echo)
...
** marginalia
#+begin_src emacs-lisp
(e:deffered-config! marginalia
  :config
  (marginalia-mode 1))
#+end_src
** orderless
#+begin_src emacs-lisp
(e:deffered-config! orderless
...
** origami
#+begin_src emacs-lisp
(e:deffered-config! origami
  :hook (prog-mode-hook . origami-mode))
#+end_src
** vertico
#+begin_src emacs-lisp
(e:deffered-config! vertico
  :priority :high
  :config
  (eval-and-compile
    (add-to-list 'load-path (f-expand "vertico/extensions" borg-drones-directory))
...
** org-superstar
#+begin_src emacs-lisp
(e:deffered-config! org-superstar
  :after (org)
...
** atomic-chrome
#+begin_src emacs-lisp
(e:deffered-config! atomic-chrome
  :config
  (atomic-chrome-start-server))
#+end_src
** apheleia
#+begin_src emacs-lisp
(e:deffered-config! apheleia
...
*** denote-menu
#+begin_src emacs-lisp
(e:deffered-config! denote-menu)
#+end_src
** devdocs
#+begin_src emacs-lisp
(e:deffered-config! devdocs
  :config
...
** doom-modeline
#+begin_src emacs-lisp
(e:deffered-config! doom-modeline
  :config
...
** dumb-jump
#+begin_src emacs-lisp
(e:deffered-config! dumb-jump
  :config
  (add-hook 'xref-backend-functions #'dumb-jump-xref-activate))
#+end_src
** editorconfig
#+begin_src emacs-lisp
(e:deffered-config! editorconfig
  :config
  (editorconfig-mode 1))
#+end_src
** elisp-demos
#+begin_src emacs-lisp
(e:deffered-config! elisp-demos
...
** git-gutter
#+begin_src emacs-lisp
(e:deffered-config! git-gutter
  :config
  (global-git-gutter-mode 1))
#+end_src
** helm
#+begin_src emacs-lisp
(e:deffered-config! helm
  :bind (([remap eval-expression] . helm-eval-expression-with-eldoc)))
#+end_src
** highlight-indentation
#+begin_src emacs-lisp
(e:deffered-config! highlight-indentation
...
** hl-todo
#+begin_src emacs-lisp
(e:deffered-config! hl-todo
  :config
  (global-hl-todo-mode 1))
#+end_src
** jinx
#+begin_src emacs-lisp
(e:deffered-config! jinx
...
** minions
#+begin_src emacs-lisp
(e:deffered-config! minions
  :config
  (minions-mode 1))
#+end_src
** open-junk-file
#+begin_src emacs-lisp
(e:deffered-config! open-junk-file
  :config
...
*** persistent-scratch
#+begin_src emacs-lisp
(e:deffered-config! persistent-scratch
  :priority :high
  :config
...
** symbol-overlay
#+begin_src emacs-lisp
(e:deffered-config! symbol-overlay
...
** undo-fu
#+begin_src emacs-lisp
(e:deffered-config! undo-fu
  :config
  (setopt evil-undo-system 'undo-fu))
#+end_src
** visual-regexp
#+begin_src emacs-lisp
(e:deffered-config! visual-regexp
  :bind ([remap query-replace] . vr/query-replace))
#+end_src
** vterm
#+begin_src emacs-lisp
(e:deffered-config! vterm
...
** wakatime-mode
#+begin_src emacs-lisp
(e:deffered-config! wakatime-mode
...
*** dap-mode
#+begin_src emacs-lisp
(e:deffered-config! dap-mode)
#+end_src
*** tree-sitter
#+begin_src emacs-lisp
(e:deffered-config! treesit-auto
...
*** bundler
#+begin_src emacs-lisp
(e:deffered-config! bundler)
#+end_src
*** projectile-rails
#+begin_src emacs-lisp
(e:deffered-config! projectile-rails
...
*** rails-routes
#+begin_src emacs-lisp
(e:deffered-config! rails-routes
  :defer-config
  (e:var! rails-routes-cache-path "rails-routes"))
#+end_src
*** rspec-mode
#+begin_src emacs-lisp
(e:deffered-config! rspec-mode
  :defer-config
...
*** vue-ts-mode
#+begin_src emacs-lisp
(e:deffered-config! vue-ts-mode
  :hook (vue-ts-mode-hook . lsp-deferred)
  :mode "\\.vue\\'")
#+end_src
*** yarn
#+begin_src emacs-lisp
(e:deffered-config! yarn
...
*** sass-mode
#+begin_src emacs-lisp
(e:deffered-config! sass-mode
  :hook (sass-mode-hook . rainbow-mode))
#+end_src
*** scss-mode
#+begin_src emacs-lisp
(e:deffered-config! scss-mode
  :hook (scss-mode-hook . rainbow-mode))
#+end_src
*** emmet-mode
#+begin_src emacs-lisp
(e:deffered-config! emmet-mode
...
(defun e:make-config ()
  ...
  (let ((default-directory user-emacs-directory)
    ...
    (set-process-sentinel
     (start-process-shell-command "e:make-config" buffer "make init-tangle")
